...
def run_generated_tests(test_dir: Path, source_files: list[Path], verbose: bool = False) -> bool:
...
"""
                ...
                if modified_source_content != source_content:
                    logger.info(f"Source file was modified, updating tests to match...")
...
def main():
    ...
    parser.add_argument('--no-testability', action='store_true', help="Don't modify source files for testability")
    parser.add_argument('--run-tests', action='store_true', help="Run tests after generating them")
