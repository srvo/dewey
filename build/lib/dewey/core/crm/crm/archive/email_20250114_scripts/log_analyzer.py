...
def log_recovery_progress(
    success_count: int, failure_count: int, total_to_process: int
) -> None:
    ...
    try:
        ...
        logger.error(f"Error logging recovery progress: {str(e)}")


def log_recovery_summary(
    total_to_process: int, success_count: int, failure_count: int
) -> None:
    ...
    try:
        ...
        logger.error(f"Error logging recovery summary: {str(e)}")
