...
class GmailClient:
    ...
    def fetch_emails(
        ...
        try:
            ...
            self.logger.error(f"Failed to fetch labels: {str(e)}")
            all_labels = {}
        ...
        try:
            ...
            while True:  # Keep going until we hit max_emails or no more messages
                ...
                for message in new_messages:
                    ...
                    try:
                        ...
                        self.logger.error(
                            f"Failed to fetch message {message['id']}: {str(e)}"
                        )
                        continue
            ...
            self.logger.error(f"Failed to fetch message list: {str(e)}")
            raise
