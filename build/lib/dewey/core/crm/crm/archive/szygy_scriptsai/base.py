...
class SyzygyAgent:
    ...
    def __init__(
        ...
        self.client = httpx.AsyncClient(
            base_url="https://api.deepinfra.com/v1/openai", timeout=60.0
        )
    ...
    @sync_to_async
    def _update_interaction(self, interaction: AgentInteraction, **kwargs):
    ...
    async def run(
        ...
        **kwargs,
        ...
        try:
            ...
            # Log error
            self.logger.error(
                "agent_run_failed", error=str(e), latency_ms=elapsed_ms, exc_info=True
            )
