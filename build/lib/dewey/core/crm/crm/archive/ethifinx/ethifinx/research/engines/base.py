...
class BaseEngine(ABC):
    ...
    def __init__(self) -> None:
        ...
        if not self.logger.handlers:
            ...
            try:
                file_handler = logging.FileHandler(f'logs/{self.__class__.__name__.lower()}.log')
            ...
            # Set overall level to DEBUG to capture everything
            self.logger.setLevel(logging.DEBUG)

        # Initialize LLM client
        self.llm = LLMClient()

    def _log_api_request(self, method: str, url: str, headers: Dict[str, str], data: Any) -> None:
    ...
    def _log_api_response(self, status_code: int, headers: Dict[str, str], data: Any) -> None:
