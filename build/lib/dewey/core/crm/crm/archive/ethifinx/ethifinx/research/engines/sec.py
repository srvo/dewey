...
class SECEngine(BaseEngine):
    ...
    async def get_company_filings(
        ...
        return await self._make_request(
            f"api/submissions/CIK{cik}/filings.json",
            params=params
        )
    ...
    async def get_mutual_fund_classes(self, series_id: str) -> Dict[str, Any]:
        ...
        """
        return await self._make_request(f"api/investment/series/{series_id}/classes")
    ...
    async def get_company_financial_statements(
        ...
        return await self._make_request(
            f"api/xbrl/companyfiling/CIK{cik}/financials.json",
            params=params
        )
