...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('date', sa.TIMESTAMP, server_default=func.current_timestamp(), nullable=False),
        ...
        sa.CheckConstraint('new_tick >= -100 AND new_tick <= 100', name='tick_range_check')
    )
