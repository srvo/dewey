...
def test_sync_emails_command(mock_imap_sync, settings):
...
@pytest.mark.django_db
def test_sync_emails_command_with_args(mock_imap_sync):
...
@pytest.mark.django_db
def test_sync_emails_command_error_handling(mock_imap_sync):
