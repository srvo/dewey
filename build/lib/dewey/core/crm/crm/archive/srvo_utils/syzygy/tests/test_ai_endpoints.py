...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_triage_endpoint(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_fallacy_endpoint(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_code_review_endpoint(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_triage_error_handling(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_fallacy_error_handling(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_code_review_error_handling(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_triage_with_all_options(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_fallacy_with_context(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_code_review_complex(authenticated_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.asyncio
async def test_ai_run(authenticated_client):
