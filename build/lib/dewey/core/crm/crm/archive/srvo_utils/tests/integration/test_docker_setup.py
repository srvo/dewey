...
def get_service_url(service, port):
...
class TestDockerSetup:
    def test_nginx_static_files(self, wait_for_services):
    ...
    def test_web_service_health(self, wait_for_services):
