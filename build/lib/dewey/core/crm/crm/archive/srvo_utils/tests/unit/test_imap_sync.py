...
def test_initialize_connection(mock_imap_client):
...
def test_sync_folder_new_email(mock_imap_client, mock_new_email_response):
...
def test_sync_folder_existing_email(mock_imap_client, mock_existing_email_response):
    ...
    assert updated_email.is_read == True


def test_sync_folder_error_handling(mock_imap_client):
...
def test_close_connection(mock_imap_client):
