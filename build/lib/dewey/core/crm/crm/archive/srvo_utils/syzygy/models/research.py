...
class ResearchIteration(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["security", "iteration_type"], name="iteration_security_idx"
            ),
...
class ResearchResults(models.Model):
    ...
    last_iteration = models.ForeignKey(
        ResearchIteration, null=True, on_delete=models.SET_NULL
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["risk_score", "confidence_score"], name="results_scores_idx"
            ),
        ]
...
class ResearchSources(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["security", "source_type"], name="sources_security_idx"
            ),
...
class Exclusion(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=["category", "criteria"], name="exclusion_category_idx"
            ),
        ]
