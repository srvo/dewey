...
class TestEmailProcessingService:
    ...
    def test_process_new_emails(self, mock_gmail_client, mock_email, mock_contact, db):
    ...
    def test_error_handling_database_failure(self, mock_gmail_client, mock_contact, db):
