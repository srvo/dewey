...
from database.models import Email, RawEmail, EventLog, Config
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stderr.write(f"Error during sync: {str(e)}")
            raise

    def _process_message(self, service, gmail_id):
