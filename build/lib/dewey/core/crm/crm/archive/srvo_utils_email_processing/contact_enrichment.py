...
from database.models import Contact, Email, EmailContactAssociation, AutomatedOperation
...
class ContactEnrichmentService(AutomatedOperation):
    ...
    def process_contact(
        self, email_address: str, name: Optional[str] = None
    ) -> Contact:
        """
        ...
        try:
            ...
            interaction_data = {
                **interaction_counts,
                ...
                "first_interaction_date": first_interaction.email.received_at
                if first_interaction
                else None,
                "last_interaction_date": last_interaction.email.received_at
                if last_interaction
                else None,
            }
