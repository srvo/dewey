...
from .models import EnrichmentTask, EnrichmentSource
...
class ContactEnricher:
    ...
    def create_enrichment_task(
        self, contact_id: str, task_type: str, metadata: Dict = None
    ) -> str:
    ...
    def update_task_status(
        ...
        try:
            ...
            self.logger.error("task_not_found", task_id=task_id)
            raise
        except Exception as e:
            self.logger.error(
                "failed_to_update_task", task_id=task_id, error=str(e), exc_info=True
            )
            raise
