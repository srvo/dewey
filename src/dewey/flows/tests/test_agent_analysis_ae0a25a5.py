...
async def test_extract_key_findings() -> None:
    await test_extract_key_findings_inner()
...
async def test_analyze_entity_with_agent() -> None:
    await test_analyze_entity_with_agent_inner()
...
async def test_analyze_entity_with_agent_error() -> None:
    await test_analyze_entity_with_agent_error_inner()


@flow
async def test_analyze_entity_with_agent_companies_inner(companies_data) -> None:
    mock_responses = {
        "Farmer Mac": {
...
async def test_analyze_entity_with_agent_companies(companies_data) -> None:
    await test_analyze_entity_with_agent_companies_inner(companies_data)
