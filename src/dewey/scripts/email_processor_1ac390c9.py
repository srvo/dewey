...
class EmailProcessingError(Exception):
    ...
    def __init__(
        self, message: str, email_id: Optional[str] = None, original_exception: Optional[Exception] = None
    ):
...
class EmailFetcher:
    ...
    def _fetch_emails(self, service: Any, last_email_id: Optional[str]) -> list[Dict[str, Any]]:
        """Fetch emails from Gmail API.

        Args:
            service: Authenticated Gmail service object.
            last_email_id: ID of the last processed email (checkpoint).
