...
class MockCredentials:
    ...
    def __init__(self, valid=True, expired=False) -> None:
...
class TestGmailClientAuthentication:
    ...
    def test_token_refresh(self, gmail_client, mock_service) -> None:
    ...
    def test_authentication_invalid_credentials(self, gmail_client) -> None:
...
class TestGmailClientEmailOperations:
    ...
    def test_fetch_emails_error_handling(self, gmail_client, mock_service) -> None:
    ...
    def test_parse_email_complete(self, gmail_client, mock_email_data) -> None:
    ...
    def test_parse_email_minimal(self, gmail_client) -> None:
...
class TestGmailClientCheckpointing:
    ...
    def test_checkpoint_save_load(self, gmail_client, tmp_path) -> None:
    ...
    def test_checkpoint_file_error_handling(self, gmail_client) -> None:
    ...
    def test_checkpoint_save_error_handling(self, gmail_client) -> None:
