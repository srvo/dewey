...
# Refactored from: priority_manager
# Date: 2025-03-16T16:19:08.404980
...
class PriorityManager:
    ...
    def _load_preferences(self) -> None:
        ...
        """
        try:
            with open(self.config.PRIORITY_CONFIG) as f:
    ...
    def _setup_logging(self) -> None:
        ...
        os.makedirs(os.path.dirname(self.edge_cases_file), exist_ok=True)
    ...
    def _prioritize_with_deepinfra(self, email_content: str) -> PriorityResult:
        ...
        with open(self.config.SYSTEM_PROMPTS / "priority.txt") as f:
        ...
        try:
            ...
            logger.exception(f"Error parsing DeepInfra response: {e}")
            msg = "Invalid response format from DeepInfra API"
            raise ValueError(msg)
    ...
    def prioritize_email(
        ...
        from_email: str,
        subject: str,
        methods: list[PrioritySource] | None = None,
    ) -> list[PriorityResult]:
        ...
        for method in methods:
            try:
                ...
                logger.exception(f"Error in {method} prioritization: {e}")
                continue
