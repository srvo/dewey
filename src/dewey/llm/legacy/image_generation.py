...
# Refactored from: image_generation
# Date: 2025-03-16T16:19:09.390828
...
class ImageGeneratorTool:
    ...
    def __init__(self, api_key: str | None = None) -> None:
        ...
        if self._api_key is None:
            msg = "STABILITY_API_KEY key is required to run image generator. Get it here: https://platform.stability.ai/account/keys"
            raise ValueError(
                msg,
            )
        if self.fileserver_url_prefix is None:
            msg = "FILESERVER_URL_PREFIX is required."
