...
# Refactored from: form_filling
# Date: 2025-03-16T16:19:11.417642
...
class FormFillingTool:
    ...
    def extract_questions(
        ...
        extract_questions_prompt = os.getenv(
            ...
            self._default_extract_questions_prompt,
        )
        ...
        if file_path:
            ...
            if table_content is None:
                msg = "Could not convert the table to markdown"
                raise ValueError(msg)
        if file_content:
    ...
    def _get_file_name_and_extension(
        ...
        if file_path is None:
            ...
            if file_extension != ".csv":
                msg = "Form filling is only supported for CSV files"
                raise ValueError(msg)
