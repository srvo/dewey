...
def search_and_print_rules(rules: list[tuple[str, str]], csv_content: str) -> None:
    """Searches for rules in the CSV content and prints matching rules.
...
def load_csv_content(csv_file: str) -> str:
...
def main(rules_file: str, csv_file: str) -> None:
    """Main function to load rules, CSV content, and search for matching rules.
    ...
    csv_content = load_csv_content(csv_file)
