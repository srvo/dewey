...
# Refactored from: polygon_engine
# Date: 2025-03-16T16:19:10.790771
...
class PolygonEngine(BaseEngine):
    ...
    async def process(self) -> Dict[str, Any]:
        ...
        Returns:
            A dictionary with the status of the engine.
        """
    ...
    async def _make_request(
        ...
        Raises:
            aiohttp.ClientError: If the API request fails after multiple attempts.
    ...
    async def get_ticker_news(
        ...
        """
        params = {"ticker": symbol, "limit": limit, "order": order, "sort": sort}
    ...
    async def get_daily_open_close(
        self, symbol: str, date: str, adjusted: bool = True
    ) -> Dict[str, Any]:
        ...
        return await self._make_request(
            f"v1/open-close/{symbol}/{date}", params=params
        )
    ...
    async def get_previous_close(
        ...
        params = {"adjusted": str(adjusted).lower()}
        return await self._make_request(
            f"v2/aggs/ticker/{symbol}/prev", params=params
        )
    ...
    async def get_trades(
        ...
        return await self._make_request(f"v3/trades/{symbol}/{date}", params=params)
    ...
    async def get_quotes(
        ...
        return await self._make_request(f"v3/quotes/{symbol}/{date}", params=params)

    async def get_financials(
        self, symbol: str, limit: int = 5, type: str = "Y", sort: str = "reportPeriod"
    ) -> Dict[str, Any]:
        ...
        """
        params = {"ticker": symbol, "limit": limit, "type": type, "sort": sort}
