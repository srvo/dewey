...
class EmailPriorities:
    ...
    def __init__(self) -> None:
        ...
        self.low_priority_rules: List[PriorityRule] = [
            PriorityRule(
                name="newsletter",
                pattern_type="subject",
        ...
        self.special_rules: List[PriorityRule] = [
            PriorityRule(
                name="security_alert",
                pattern_type="subject",
    ...
    def determine_priority(
        ...
        if client_result:
            priority, category, requires_response = client_result
            return {
                "priority": priority,
                "category": category,
        ...
        for rule in self.high_priority_rules:
            ...
            if rule_result:
                priority, category, requires_response = rule_result
                return {
                    "priority": priority,
                    "category": category,
                    "requires_response": requires_response,
