...
def add_enrichment_capabilities() -> None:
    """Add enrichment capabilities while preserving existing functionality.
    ...
    try:
        ...
        logger.info("Adding enrichment fields to contacts table")
        ...
        logger.info("Creating enrichment tasks table")
        cursor.execute(
            """
        ...
        logger.info("Creating enrichment sources table")
        cursor.execute(
            """
        ...
        logger.info("Creating indexes for enrichment tables")
        ...
        conn.commit()
        logger.info("Successfully added enrichment capabilities")

    except Exception as e:
        logger.exception(f"Error adding enrichment capabilities: {e!s}")
        if conn:
            conn.rollback()
        raise
    finally:
...
if __name__ == "__main__":
    ...
    """
    logger.info("Starting enrichment capabilities migration")
    try:
        add_enrichment_capabilities()
        logger.info("Enrichment capabilities migration completed successfully")
    except Exception as e:
