...
class GmailAPIClient:
    ...
    def __init__(self, config=None):
        ...
        # Set up scopes
        self.scopes = self.config.get('settings.gmail_scopes', [
            'https://www.googleapis.com/auth/gmail.readonly',
            'https://www.googleapis.com/auth/gmail.modify'
        ])
        self.oauth_token_uri = self.config.get('settings.oauth_token_uri', 'https://oauth2.googleapis.com/token')
    ...
    def fetch_message(self, msg_id: str, user_id: str = 'me') -> Optional[Dict[str, Any]]:
