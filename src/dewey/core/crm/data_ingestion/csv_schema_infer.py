...
class CSVInferSchema(BaseScript):
    ...
    def run(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Successfully created table {table_name} from {csv_file_path}")
    ...
    def _insert_data(self, csv_file_path: str, table_name: str, schema: Dict[str, str]) -> None:
        """
