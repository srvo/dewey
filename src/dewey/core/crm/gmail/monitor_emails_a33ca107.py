...
def get_stats() -> Dict[str, Any]:
    ...
    with get_db_connection() as conn:
        ...
        last_hour_count: int = cursor.fetchone()[0]
        ...
        latest_date: str | None = result[0] if result else None
...
def display_stats(stats: Dict[str, Any], start_time: datetime) -> None:
...
def monitor_emails(refresh_interval: int = 5) -> None:
