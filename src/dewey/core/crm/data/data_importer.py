...
class DataImporter(BaseScript):
        ...
        try:
            ...
            for chunk_index, chunk in enumerate(df_iterator):
                ...
                if records:
                    ...
                    self.logger.info(f"Imported chunk {chunk_index+1} with {len(records)} rows")
    ...
    def run(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Data import completed. Imported {rows_imported} rows to {table_name}")
