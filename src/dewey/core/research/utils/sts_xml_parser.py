...
# Refactored from: sts_xml_parser
# Date: 2025-03-16T16:19:09.352741
...
class STSElement:
    ...
    def __init__(self, root_name, element) -> None:
    ...
    def fromstring(cls, root_name, data):
        ...
        try:
            ...
            msg = f'"{root_name}" XML is not parsable. Message: {error.message}'
    ...
    def get_child_text(self, name, strict=True):
        ...
        if strict:
            try:
                ...
                msg = (
                    f'Invalid XML provided for "{self.root_name}" - erroring tag <{name}>. '
