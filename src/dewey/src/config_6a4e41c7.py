...
class Settings(BaseSettings):
    ...
    def convert_to_path(self, value: str | Path) -> Path:
...
class TestSettings(Settings):
    ...
    _test_config: dict | None = None  # Stores test-specific configuration overrides
    _instance: TestSettings | None = None  # Singleton instance reference
