...
class EmailPrioritizer:
    ...
    def _load_json(self, filename: str) -> Dict:
        ...
        Returns:
            A dictionary representing the loaded JSON data, or an empty dictionary
            if loading fails.
        """
        try:
    ...
    def _score_with_deepinfra(self, email: Email) -> Tuple[int, float, str]:
        ...
        Returns:
            A tuple containing the priority score, confidence, and reason.

        Raises:
            ValueError: If DEEPINFRA_API_KEY is not set or if the API response
                is invalid.
    ...
    def _deterministic_score(self, email: Email) -> Tuple[int, float, str]:
        """Score email deterministically based on keywords and rules.
    ...
    def _log_edge_case(
        ...
        Args:
            ...
            reason: The reason for the edge case.
        """
        edge_case = {
