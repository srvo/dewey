...
# Refactored from: db_converters
# Date: 2025-03-16T16:19:10.348537
...
from ..research.workflows.analysis_tagger import AnalysisSummary, AnalysisTags
...
def workflow_to_database(
    ...
    try:
        ...
        logger.exception("Missing required workflow data: %s", str(e))
        raise
...
def database_to_workflow(database_data: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        logger.exception("Missing required database field: %s", str(e))
        raise
    except Exception as e:
