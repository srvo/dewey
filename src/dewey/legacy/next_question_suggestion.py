...
# Refactored from: next_question_suggestion
# Date: 2025-03-16T16:19:10.103843
...
class NextQuestionSuggestion:
    ...
    @classmethod
    def get_configured_prompt(cls) -> str | None:
    ...
    async def suggest_next_questions_all_messages(
        ...
        try:
            ...
            logger.exception(f"Error when generating next question: {e}")
            return None
