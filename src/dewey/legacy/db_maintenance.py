...
# Refactored from: db_maintenance
# Date: 2025-03-16T16:19:11.443097
...
def check_database_health() -> bool:
    ...
    try:
        ...
        logger.exception(f"Database health check failed: {e!s}")
        return False
...
class DatabaseMaintenance:
    ...
    def perform_maintenance(self) -> bool:
        ...
        try:
            ...
            logger.exception(f"Maintenance failed: {e!s}")
            return False
