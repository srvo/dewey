...
def initialize_database() -> None:
    """Initializes the database connection and performs a health check.
...
class EmailService:
    ...
    def __init__(
        ...
        """Initializes the email service with configuration and dependencies.
    ...
    def fetch_cycle(self) -> None:
        """Executes a single email fetch cycle.
    ...
    def run(self) -> None:
        """Runs the service in a continuous loop.
...
def run_service(interval_minutes: int = 15) -> None:
    """Runs the email service with default configuration.
