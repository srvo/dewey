...
def main():
    ...
    parser.add_argument('--batch-size', type=int, help='Number of emails to process in each batch')
    ...
    try:
        ...
        def signal_handler(sig, frame):
            logger.info("Received interrupt signal in wrapper, forwarding to processor...")
        ...
        logger.info("✨ This process will sync new emails, extract contacts, and calculate priorities")
