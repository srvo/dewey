...
# Refactored from: mccabe
# Date: 2025-03-16T16:19:10.494739
...
class ASTVisitor:
    ...
    def preorder(self, tree, visitor, *args) -> None:
...
class PathNode:
    def __init__(self, name, look="circle") -> None:
        self.name = name
        self.look = look
...
class PathGraph:
    def __init__(self, name, entity, lineno, column=0) -> None:
        self.name = name
        self.entity = entity
        self.lineno = lineno
        self.column = column
...
class PathGraphingAstVisitor(ASTVisitor):
    ...
    def _subgraph_parse(self, node, pathnode, extra_blocks) -> None:
