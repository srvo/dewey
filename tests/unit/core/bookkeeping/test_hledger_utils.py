...
class TestHledgerUtils:
    ...
    def test_update_opening_balances_success(self, mock_subprocess, mock_path, tmp_path):
...
"""
        ...
        with patch("dewey.core.bookkeeping.hledger_utils.get_balance") as mock_get_balance:
    ...
    def test_main_function(self):
        ...
        with patch("dewey.core.bookkeeping.hledger_utils.update_opening_balances") as mock_update:
