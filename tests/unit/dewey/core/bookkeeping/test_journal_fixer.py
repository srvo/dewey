...
def test_parse_transactions_invalid_date_format(journal_fixer: JournalFixer, caplog: pytest.LogCaptureFixture) -> None:
...
def test_parse_transactions_empty_transaction_lines(journal_fixer: JournalFixer, caplog: pytest.LogCaptureFixture) -> None:
