...
class TestMercuryImporter:
    ...
    def test_run_api_key_found(
        self, mock_get_config_value: pytest.fixture, mercury_importer: MercuryImporter, caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    def test_get_config_value_existing_key(self, mercury_importer: MercuryImporter) -> None:
    ...
    def test_get_config_value_nested_key(self, mercury_importer: MercuryImporter) -> None:
    ...
    def test_get_config_value_default_value(self, mercury_importer: MercuryImporter) -> None:
        """Test that get_config_value returns the default value for a non-existing key."""
        mercury_importer.config = {}
        assert mercury_importer.get_config_value("non_existing_key", "default_value") == "default_value"

    def test_get_config_value_non_existing_key(self, mercury_importer: MercuryImporter) -> None:
