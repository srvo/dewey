...
class TestDatabaseErrorHandler:
    ...
    def test_run_error_logged(
        self, mock_error: logging.Logger, error_handler: DatabaseErrorHandler
    ) -> None:
    ...
    def test_run_handle_error_called(
        self,
        mock_handle_error: DatabaseErrorHandler,
    ...
    def test_handle_error_log(
        self, mock_info: logging.Logger, error_handler: DatabaseErrorHandler
    ) -> None:
    ...
    def test_handle_error_unknown(
        self, mock_warning: logging.Logger, error_handler: DatabaseErrorHandler
    ) -> None:
    ...
    @patch.object(logging.Logger, "info")
    def test_handle_error_config_default(
        self, mock_info: logging.Logger, error_handler: DatabaseErrorHandler
    ) -> None:
    ...
    def test_get_config_value_missing_key(
        ...
        assert (
            error_handler.get_config_value("missing_key", "default_value")
            == "default_value"
        )
    ...
    def test_get_config_value_missing_nested_key(
        ...
        assert (
            error_handler.get_config_value("nested.missing_key", "default_value")
            == "default_value"
        )
    ...
    def test_get_config_value_invalid_key(
        ...
        error_handler.config = {"test_key": "test_value"}
        assert (
            error_handler.get_config_value("test_key.invalid_key", "default_value")
            == "default_value"
        )
