...
class TestFMPEngine:
    ...
    def fmp_engine(self) -> FMPEngine:
        ...
        with patch(
            "dewey.core.engines.fmp_engine.FMPEngine.get_config_value"
    ...
    def test_run_success(
        self, fmp_engine: FMPEngine, caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    def test_get_data_logs_endpoint(
        self, fmp_engine: FMPEngine, caplog: pytest.LogCaptureFixture
    ) -> None:
