...
class TestPrecommitAnalyzer:
    ...
    @patch("dewey.core.maintenance.precommit_analyzer.PrecommitAnalyzer.get_config_value")
    def test_run(self, mock_get_config_value, precommit_analyzer: PrecommitAnalyzer, caplog) -> None:
    ...
    @patch("dewey.core.maintenance.precommit_analyzer.PrecommitAnalyzer.get_config_value")
    def test_run_config_value_override(self, mock_get_config_value, precommit_analyzer: PrecommitAnalyzer, caplog) -> None:
    ...
    def test_get_config_value_existing_key(self, precommit_analyzer: PrecommitAnalyzer) -> None:
    ...
    def test_get_config_value_default_value(self, precommit_analyzer: PrecommitAnalyzer) -> None:
        """Test getting a non-existing config value with a default."""
        precommit_analyzer.config = {"section": {}}
        value = precommit_analyzer.get_config_value("section.non_existent_key", "default")
        assert value == "default"

    def test_get_config_value_nested_key(self, precommit_analyzer: PrecommitAnalyzer) -> None:
    ...
    def test_get_config_value_missing_section(self, precommit_analyzer: PrecommitAnalyzer) -> None:
    ...
    def test_get_config_value_no_default(self, precommit_analyzer: PrecommitAnalyzer) -> None:
