...
from dewey.core.research.management.company_analysis_manager import (
    CompanyAnalysisManager,
)


class TestCompanyAnalysisManager(unittest.TestCase):
    """Class TestCompanyAnalysisManager."""
    ...
    def setUp(self):
        ...
        self.manager.config = {
            "company_analysis": {"company_ticker": "TEST"},
            "core": {"database": {}},
            "llm": {},
        }
    ...
    def test_run_success(self):
        ...
        self.manager._analyze_company = MagicMock(
            return_value=self.test_analysis_results
        )
        ...
        self.manager._store_analysis_results.assert_called_with(
            self.test_ticker, self.test_analysis_results
        )
    ...
    def test_run_no_ticker(self):
        ...
        self.assertEqual(
            str(context.exception), "Company ticker not found in configuration."
        )
    ...
    def test_analyze_company_llm_failure(self):
        ...
        self.assertEqual(
            str(context.exception), "LLM analysis failed to return a response."
        )
        self.manager.logger.error.assert_called()
    ...
    def test_store_analysis_results_success(self):
        ...
        self.manager._store_analysis_results(
            self.test_ticker, self.test_analysis_results
        )
    ...
    @patch(
        "argparse.ArgumentParser.parse_args", return_value=MagicMock(log_level="DEBUG")
    )
    ...
    @patch(
        "argparse.ArgumentParser.parse_args",
        return_value=MagicMock(db_connection_string="test_db_string"),
    )
