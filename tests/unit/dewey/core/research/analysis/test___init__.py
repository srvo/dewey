...
class TestAnalysisScript:
    ...
    def test_analysis_script_initialization(
        self, analysis_script: AnalysisScript
    ) -> None:
    ...
    def test_analysis_script_initialization_no_config_section(self) -> None:
        ...
        with patch.object(BaseScript, "_load_config", return_value=None):
    ...
    def test_config_loaded_correctly(
        self, analysis_script: AnalysisScript, mock_config: Dict[str, Any]
    ) -> None:
    ...
    def test_get_path_relative(self, analysis_script: AnalysisScript) -> None:
        ...
        expected_path = Path(__file__).parent.parent.parent.parent.joinpath(
            relative_path
        )
    ...
    def test_get_config_value_default_value(
        ...
        assert (
            analysis_script.get_config_value("non_existent_key", "default_value")
            == "default_value"
        )

    def test_get_config_value_non_existent_key(
        self, analysis_script: AnalysisScript
    ) -> None:
    ...
    def test_config_section_not_found(
        self, mock_load_config: MagicMock, analysis_script: AnalysisScript
    ) -> None:
