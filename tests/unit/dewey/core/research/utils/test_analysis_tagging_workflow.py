...
class TestAnalysisTaggingWorkflow:
    ...
    def test_init(self) -> None:
        ...
        workflow = AnalysisTaggingWorkflow(config_section="test_section", requires_db=True, enable_llm=True)
    ...
    @patch("dewey.core.research.utils.analysis_tagging_workflow.AnalysisTaggingWorkflow.get_config_value")
    def test_run_tagging_enabled(self, mock_get_config_value: Any, analysis_tagging_workflow: AnalysisTaggingWorkflow, caplog: Any) -> None:
    ...
    @patch("dewey.core.research.utils.analysis_tagging_workflow.AnalysisTaggingWorkflow.get_config_value")
    def test_run_tagging_disabled(self, mock_get_config_value: Any, analysis_tagging_workflow: AnalysisTaggingWorkflow, caplog: Any) -> None:
    ...
    @patch("dewey.core.research.utils.analysis_tagging_workflow.AnalysisTaggingWorkflow.get_config_value")
    def test_run_config_exception(self, mock_get_config_value: Any, analysis_tagging_workflow: AnalysisTaggingWorkflow, caplog: Any) -> None:
