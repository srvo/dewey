...
from dewey.core.crm.gmail.gmail_sync_manager import GmailSyncManager  # Assuming you will create this class
...
class TestGmailSyncManager:
    ...
    def mock_base_script(self):
        ...
        with patch.object(BaseScript, '_setup_logging') as mock_setup_logging, \
    ...
    def test_gmail_sync_manager_initialization(self, mock_base_script):
        ...
        mock_setup_logging, mock_load_config, mock_init_db, mock_init_llm = mock_base_script
