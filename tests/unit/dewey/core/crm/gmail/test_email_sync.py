...
class TestEmailSync:
    ...
    def email_sync(self) -> EmailSync:
        ...
        with patch(
            "dewey.core.crm.gmail.email_sync.BaseScript.__init__", return_value=None
        ):
    ...
    def test_init(self) -> None:
        ...
        with patch("dewey.core.crm.gmail.email_sync.BaseScript.__init__") as mock_init:
            ...
            mock_init.assert_called_once_with(
                config_section="test_section", arg1="value1", kwarg1="value2"
            )
    ...
    def test_run_api_key_found(self, email_sync: EmailSync) -> None:
        ...
        email_sync.logger.debug.assert_called_with(
            "Gmail API key found in configuration."
        )
    ...
    def test_run_api_key_not_found(self, email_sync: EmailSync) -> None:
        ...
        email_sync.logger.info.assert_called_with("Email synchronization completed.")
        email_sync.logger.warning.assert_called_with(
            "Gmail API key not found in configuration."
        )
