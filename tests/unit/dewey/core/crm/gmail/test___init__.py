...
class TestGmailModule:
    ...
    def test_get_config_value(self, gmail_module: GmailModule) -> None:
        ...
        assert (
            gmail_module.get_config_value("nonexistent_key", "default_value")
            == "default_value"
        )
        assert (
            gmail_module.get_config_value("nested.key", "default_value")
            == "default_value"
        )
    ...
    def test_get_config_value_no_config(self, gmail_module: GmailModule) -> None:
        ...
        assert (
            gmail_module.get_config_value("test_key", "default_value")
            == "default_value"
        )
    ...
    def test_get_config_value_empty_string_default(
        self, gmail_module: GmailModule
    ) -> None:
