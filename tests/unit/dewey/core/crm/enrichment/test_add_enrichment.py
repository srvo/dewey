...
class TestAddEnrichmentCapabilities:
    ...
    @patch("dewey.core.crm.enrichment.add_enrichment.AddEnrichmentCapabilities.get_config_value")
    def test_run_success(
        ...
        add_enrichment_capabilities.logger.info.assert_called_with("Successfully added enrichment capabilities")
    ...
    def test_cleanup(self, add_enrichment_capabilities: AddEnrichmentCapabilities, mock_sqlite_connection: MagicMock) -> None:
        ...
        mock_sqlite_connection.close.assert_called_once()
        add_enrichment_capabilities.logger.debug.assert_called_with("Closing database connection")

    def test_cleanup_no_connection(self, add_enrichment_capabilities: AddEnrichmentCapabilities) -> None:
    ...
    def test_cleanup_close_error(self, add_enrichment_capabilities: AddEnrichmentCapabilities, mock_sqlite_connection: MagicMock) -> None:
    ...
    def test_get_path_absolute(self, add_enrichment_capabilities: AddEnrichmentCapabilities) -> None:
    ...
    def test_get_path_relative(self, add_enrichment_capabilities: AddEnrichmentCapabilities) -> None:
    ...
    def test_get_config_value_existing(self, add_enrichment_capabilities: AddEnrichmentCapabilities) -> None:
    ...
    def test_get_config_value_default(self, add_enrichment_capabilities: AddEnrichmentCapabilities) -> None:
        """Test get_config_value with a non-existing key and a default value."""
        add_enrichment_capabilities.config = {"level1": {"level2": "value"}}
        result = add_enrichment_capabilities.get_config_value("level1.level3", "default")
        assert result == "default"

    def test_get_config_value_missing(self, add_enrichment_capabilities: AddEnrichmentCapabilities) -> None:
