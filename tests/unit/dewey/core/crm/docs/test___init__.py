...
class TestDocsModule:
    ...
    def test_run_method(self, docs_module: DocsModule, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_run_method_with_config_value(self, docs_module: DocsModule, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_get_config_value_nested_key(self, docs_module: DocsModule) -> None:
        ...
        with patch.object(docs_module, 'config', {'nested': {'example_setting': 'nested_value'}}):
    ...
    def test_get_config_value_nested_key_missing(self, docs_module: DocsModule) -> None:
        ...
        with patch.object(docs_module, 'config', {'nested': {}}):
            value = docs_module.get_config_value('nested.missing_setting', 'default_value')
            assert value == 'default_value'
