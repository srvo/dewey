...
class TestPriorityManager:
    ...
    def priority_manager(self) -> PriorityManager:
        ...
        with (
            patch("dewey.core.crm.priority.priority_manager.DatabaseConnection"),
            patch("dewey.core.crm.priority.priority_manager.get_connection"),
    ...
    def test_init(self) -> None:
        ...
        with (
            ...
            assert (
                priority_manager.description == "Manages priority within Dewey's CRM."
            )
    ...
    def test_run_with_db_success(self, priority_manager: PriorityManager) -> None:
        ...
        with patch(
            "dewey.core.crm.priority.priority_manager.execute_query", mock_execute_query
        ):
            priority_manager.run()
    ...
    def test_run_with_llm_success(self, priority_manager: PriorityManager) -> None:
        ...
        with patch(
            "dewey.core.crm.priority.priority_manager.generate_text", mock_generate_text
        ):
            priority_manager.run()
    ...
    def test_run_no_db_connection(self, priority_manager: PriorityManager) -> None:
        ...
        priority_manager.logger.warning.assert_called_with(
    ...
    def test_config_value_retrieval(self, priority_manager: PriorityManager) -> None:
        ...
        assert (
            priority_manager.get_config_value("section.missing_key", "default")
            == "default"
        )
        assert (
            priority_manager.get_config_value("missing_section.key", "default")
            == "default"
        )
        assert (
            priority_manager.get_config_value("missing_section", "default") == "default"
        )
        assert priority_manager.get_config_value("section.key") == "value"

    def test_config_value_retrieval_no_default(
...
"""
    ...
    def test_cleanup_db_connection_error(
        self, priority_manager: PriorityManager
    ) -> None:
    ...
    def test_parse_args_config(self, priority_manager: PriorityManager) -> None:
        ...
        with (
            patch(
                "argparse.ArgumentParser.parse_args",
                return_value=MagicMock(config="test_config.yaml"),
            ),
            patch(
                "dewey.core.crm.priority.priority_manager.open", create=True
            ) as mock_open,
...
"""
    ...
    def test_execute_success(self, priority_manager: PriorityManager) -> None:
        ...
        with (
            patch(
                "dewey.core.crm.priority.priority_manager.PriorityManager.parse_args",
            ...
            patch(
                "dewey.core.crm.priority.priority_manager.PriorityManager._cleanup"
            ) as mock_cleanup,
        ):
