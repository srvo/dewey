...
class TestEmailPrioritization:
    ...
    def test_run_success(self, email_prioritization: EmailPrioritization, caplog) -> None:
    ...
    def test_run_exception(self, email_prioritization: EmailPrioritization, caplog) -> None:
        """Test the run method when an exception occurs."""
        caplog.set_level(logging.INFO)
        email_prioritization.logger.info = MagicMock(side_effect=Exception("Test Exception"))
