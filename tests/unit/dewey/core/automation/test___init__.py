...
class TestAutomationModule:
    ...
    def test_init_default_config_section(self, automation_module: AutomationModule) -> None:
    ...
    def test_run_method(self, mock_logger: Any, mock_get_config_value: Any, automation_module: AutomationModule) -> None:
    ...
    def test_get_config_value(self, mock_super_get_config_value: Any, automation_module: AutomationModule) -> None:
    ...
    def test_get_config_value_no_default(self, automation_module: AutomationModule) -> None:
    ...
    def test_get_config_value_default_returned(self, automation_module: AutomationModule) -> None:
    ...
    def test_get_config_value_key_not_found(self, automation_module: AutomationModule) -> None:
    ...
    @patch('dewey.core.automation.AutomationModule.logger')
    def test_run_no_exception(self, mock_logger: Any, automation_module: AutomationModule) -> None:
    ...
    @patch('dewey.core.automation.AutomationModule.get_config_value')
    @patch('dewey.core.automation.AutomationModule.logger')
    def test_run_config_value(self, mock_logger: Any, mock_get_config_value: Any, automation_module: AutomationModule) -> None:
