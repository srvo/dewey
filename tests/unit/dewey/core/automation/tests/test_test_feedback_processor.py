...
class TestFeedbackProcessor:
    ...
    def test_base_script_inheritance(self):
        ...
        with patch(
            "dewey.core.automation.tests.test_feedback_processor.FeedbackProcessor",
            create=True,
        ) as MockFeedbackProcessor:
            MockFeedbackProcessor.mro.return_value = [
                BaseScript
            ]  # Mock the inheritance
