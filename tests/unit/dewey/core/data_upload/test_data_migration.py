...
class TestDataMigration:
    ...
    def test_write_data(
        ...
        with caplog.records_property() as records:
            ...
            assert records[0].levelname == "INFO"
            assert (
                "Writing data to destination type: test_destination"
    ...
    @patch("dewey.core.data_upload.data_migration.DataMigration.get_config_value")
    def test_read_data_config_error(
        self,
        mock_get_config_value: Any,
        data_migration: DataMigration,
        caplog: pytest.LogCaptureFixture,
    ...
    @patch("dewey.core.data_upload.data_migration.DataMigration.get_config_value")
    def test_transform_data_config_error(
        self,
        mock_get_config_value: Any,
        data_migration: DataMigration,
        caplog: pytest.LogCaptureFixture,
    ...
    @patch("dewey.core.data_upload.data_migration.DataMigration.get_config_value")
    def test_write_data_config_error(
        self,
        mock_get_config_value: Any,
        data_migration: DataMigration,
        caplog: pytest.LogCaptureFixture,
    ...
    def test_execute_method(
        self, data_migration: DataMigration, caplog: pytest.LogCaptureFixture
    ) -> None:
        """Test the execute method."""
        with (
            patch.object(DataMigration, "parse_args") as mock_parse_args,
    ...
    def test_get_path_absolute(
        self, mock_isabs: Any, data_migration: DataMigration
    ) -> None:
    ...
    def test_get_config_value(
        self, mock_load_config: Any, data_migration: DataMigration
    ) -> None:
    ...
    def test_setup_argparse(
        self, mock_setup_argparse: Any, data_migration: DataMigration
    ) -> None:
    ...
    def test_parse_args(
        self, mock_parse_args: Any, data_migration: DataMigration
    ) -> None:
