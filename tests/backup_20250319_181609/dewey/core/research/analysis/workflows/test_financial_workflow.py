...
class TestFinancialAnalysis:
    ...
    def test_get_current_universe(self, mock_db_connection, mock_stocks_data):
        ...
        with patch("dewey.core.research.analysis.financial_analysis.get_connection", 
    ...
    def test_analyze_material_events(self, mock_db_connection, mock_metrics_data):
        ...
        with patch("dewey.core.research.analysis.financial_analysis.get_connection", 
                  return_value=mock_db_connection):
            with patch("dewey.core.research.analysis.financial_analysis.analyze_financial_changes", 
    ...
    def test_main_function(self, mock_db_connection, mock_stocks_data, mock_metrics_data):
        ...
        with patch("dewey.core.research.analysis.financial_analysis.get_connection", 
                  return_value=mock_db_connection):
            with patch("dewey.core.research.analysis.financial_analysis.analyze_material_events", 
    ...
    def test_full_analysis_workflow(self, mock_db_connection, mock_stocks_data, mock_metrics_data):
