...
class TestDeferredRevenueProcessor:
    ...
    def test_create_recognition_schedule(self, processor):
        ...
        assert all(e.amount == 1000.00 for e in schedule.entries)  # Equal monthly amounts
    ...
    def test_full_revenue_recognition_workflow(self, processor, sample_deferred_revenue_data):
