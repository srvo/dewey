...
class TestTaxReportingProcessor:
    ...
    def test_categorize_transactions(self, processor, sample_transactions):
        ...
        income_items = [t for t in categorized if t["tax_category"] == TaxCategory.BUSINESS_INCOME]
        expense_items = [t for t in categorized if t["tax_category"] == TaxCategory.BUSINESS_EXPENSE]
        capital_items = [t for t in categorized if t["tax_category"] == TaxCategory.CAPITAL_EXPENSE]
    ...
    def test_generate_schedule_c(self, processor, sample_transactions):
        ...
        assert schedule_c["net_profit"] == schedule_c["gross_income"] - schedule_c["total_expenses"]
    ...
    def test_validate_reporting_period(self, processor):
        ...
        invalid_periods = [
            ...
            ReportingPeriod(
                ...
                end_date=date(2023, 12, 31)  # Wrong year
            )
        ]
    ...
    def test_full_tax_reporting_workflow(self, processor, sample_transactions):
        ...
        capital_items = [t for t in sample_transactions 
