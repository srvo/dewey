...
class TestBackupFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.backup_dir_patcher = patch('src.dewey.core.db.backup.BACKUP_DIR', self.temp_dir)
        self.mock_backup_dir = self.backup_dir_patcher.start()
        
        self.local_db_path_patcher = patch('src.dewey.core.db.backup.LOCAL_DB_PATH', 
    ...
    def test_create_backup(self):
        ...
        with patch('shutil.copy2') as mock_copy:
            ...
            with patch('src.dewey.core.db.backup.datetime') as mock_datetime:
                ...
                # Check backup path
                expected_path = os.path.join(self.temp_dir, "dewey_backup_20230115_123045.duckdb")
    ...
    def test_restore_backup(self):
        ...
        with patch('src.dewey.core.db.backup.create_backup') as mock_create:
            mock_create.return_value = os.path.join(self.temp_dir, "current_backup.duckdb")
            ...
            with patch('shutil.copy2') as mock_copy:
                ...
                mock_copy.assert_called_with(backup_path, os.path.join(self.temp_dir, 'dewey.duckdb'))
