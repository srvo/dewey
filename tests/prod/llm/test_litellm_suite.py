...
def create_test_suite():
    ...
    test_suite.addTest(unittest.makeSuite(TestLiteLLMClient))
    test_suite.addTest(unittest.makeSuite(TestLiteLLMUtils))
    test_suite.addTest(unittest.makeSuite(TestLLMExceptions))
    test_suite.addTest(unittest.makeSuite(TestLiteLLMIntegration))
